...
public class MyRcyViewAdapter extends RecyclerView.Adapter<MyRcyViewAdapter.ViewHolder>{

    private Context context;
    private List<Data.ItemListBeanX.DataBeanX.ItemListBean>list;



    public MyRcyViewAdapter(Context context, List<Data.ItemListBeanX.DataBeanX.ItemListBean> list) {
